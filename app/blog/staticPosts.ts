...
export const STATIC_POSTS: StaticBlogPost[] = [
  ...
  },
  {
    ...
    "title": "Native Medicine Garden Flower Guide: Budget, Premium and Exotic Sections",
    "seoTitle": "Native Medicine Garden Flower Guide | Toronto Budget to Exotic",
    "seo_title": "Native Medicine Garden Flower Guide | Toronto Budget to Exotic",
    "metaDescription": "Compare Native Medicine Garden flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "meta_description": "Compare Native Medicine Garden flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "h1": "Native Medicine Garden Flower Guide: Budget, Premium and Exotic Sections",
    "excerpt": "A clear flower guide for Native Medicine Garden, from cheap weed and budget weed searches to premium flower and exotic flower browsing.",
    "authorName": "Maya Cedar",
    "authorHandle": "@MayaMedicine",
    "authorRole": "House Writer",
    "author": "Maya Cedar",
  ...
  },
  {
    ...
    "title": "Native Medicine Garden Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "seoTitle": "Native Medicine Garden Menu Guide | Toronto Weed Store Categories",
    "seo_title": "Native Medicine Garden Menu Guide | Toronto Weed Store Categories",
    "metaDescription": "Use this Native Medicine Garden menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "meta_description": "Use this Native Medicine Garden menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "h1": "Native Medicine Garden Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "excerpt": "A practical Toronto menu guide for Native Medicine Garden, with natural category paths for adults 19+.",
    "authorName": "Noah Medicine",
    "authorHandle": "@NoahNative",
    "authorRole": "House Writer",
    "author": "Noah Medicine",
