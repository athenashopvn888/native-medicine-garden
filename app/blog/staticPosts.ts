...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "relatedLinks": [
      ...
      {
        "title": "Native Medicine Garden store page",
        "url": "/weed-dispensary-toronto",
        "description": "Check the Downtown Toronto store page for address, phone, hours, and visit details."
      },
      {
        "title": "Native Medicine Garden blog",
        "url": "/blog",
    ...
    "editorialRemark": {
      ...
      "authorName": "Maya Cedar",
      "authorHandle": "@MayaMedicine",
      "authorRole": "House Writer",
      "body": "The address check is not boring; it is the part that saves the trip. Store names and old tabs can blur together, so matching Gerrard St W, the phone number, and the current page is worth the minute. A little structure makes the menu easier to use, especially when the flower tiers start to blur together."
    },
  },
  {
    "slug": "native-medicine-garden-price-flower-tier-guide",
    "title": "How to Read the Native Medicine Garden Flower Menu",
    "seoTitle": "How to Read the Native Medicine Garden Flower Menu | Toronto",
    "seo_title": "How to Read the Native Medicine Garden Flower Menu | Toronto",
    "metaDescription": "How to Read the Native Medicine Garden Flower Menu with natural notes on Budget, AA, AAA+, Premium, and Exotic flower for Toronto shoppers.",
    "meta_description": "How to Read the Native Medicine Garden Flower Menu with natural notes on Budget, AA, AAA+, Premium, and Exotic flower for Toronto shoppers.",
    "h1": "How to Read the Native Medicine Garden Flower Menu",
    "excerpt": "A cleaner way to compare Native Medicine Garden flower tiers, from budget weed to premium and exotic flower.",
    "authorName": "Maya Cedar",
    "authorHandle": "@MayaMedicine",
    "authorRole": "House Writer",
    "author": "By Maya Cedar \\u00b7 @MayaMedicine",
    "structuredAuthorName": "Native Medicine Garden Editorial Team",
    "date": "2026-07-09",
    "modifiedDate": "2026-07-11",
    "category": "Flower Guide",
    "readTime": "4 min",
    "content": "Flower menus get easier when you stop reading them like a novel. At Native Medicine Garden, the useful first move is to choose the flower lane: Budget, AA, AAA+, Premium, or Exotic. Once the lane is right, compare the current strains and weights on the live page.\n\nThat is the whole advantage of a tiered cannabis menu. It lets someone looking for cheap weed in Toronto start low without apology, while someone chasing premium flower or exotic flower can skip straight to the higher shelves. Same menu, less wandering.\n\n## The Flower Lanes\n\nBudget is the value lane. It is the place to start when affordable weed is the main mission and the exact strain can come second. AA is still value-minded, but it gives shoppers another step above the lowest price lane. AAA+ is the middle lane for people who want stronger flower-page filtering without immediately jumping into the top tiers.\n\nPremium flower is for shoppers who want the menu to feel a little more selective. Exotic flower is the top lane and should be checked when the first question is not simply price. None of those labels replace the live product listing. They organize the browse so you know where to look first.\n\n## Read Price And Weight Together\n\nA flower price only tells half the story if you do not look at the weight beside it. The menu structure commonly shows smaller single-gram pricing and larger bundle-style weights, so compare the total spend and the approximate value per gram before deciding. That is where weed deals become clearer without turning the page into math class.\n\nBudget and AA can make sense for routine value shopping. AAA+ often works as the comparison lane when you want more strength from the menu without going straight to the top. Premium and Exotic are where quality-first shoppers usually start. If you are unsure, open two tiers side by side and compare the current listings instead of guessing from the label alone.\n\n## Local Search, Real Page\n\nNative Medicine Garden is listed at 76 Gerrard St W, Toronto, ON M5G 1J5, with the site listing the store as open 24 hours. If you are comparing a weed store in Toronto, use those details to confirm you are in the right place, then let the flower tiers do the sorting.\n\nThe clean move: choose Budget for cheap weed, AA or AAA+ for value-plus browsing, Premium for a stronger flower lane, and Exotic when top-tier flower is the point. Then check the live page before visiting, because cannabis menus change and pretending otherwise is how people end up annoyed at a counter. A little structure makes the menu easier to use, especially when the flower tiers start to blur together.\n\n## FAQ\n\n### Which flower tier should I check first?\nStart with the tier that matches the trip: Budget for value, AA or AAA+ for middle-lane browsing, Premium for higher-grade flower, and Exotic for the top lane.\n\n### Does this guide guarantee prices or stock?\nNo. It explains how to read the menu structure. Use the live category page for current listings.\n\n### Why do weights matter?\nDifferent weights can change the practical value. Compare the total price and the amount before choosing.\n\n### Is this useful for local Toronto shoppers?\nYes. It is written for people checking Native Medicine Garden and its current flower menu before visiting.",
    "faq": "",
    "relatedLinks": [
      {
        "title": "Budget flower",
    ...
    "editorialRemark": {
      "label": "Another House Writer Adds",
      "authorName": "Native Medicine Desk",
      "authorHandle": "@NativeMedicineDesk",
  ...
  },
  {
    ...
    "editorialRemark": {
      ...
      "authorHandle": "@NoahNative",
      "authorRole": "House Writer",
      "body": "The category split is doing more work than people notice. A shopper looking for pre-rolls, edibles, THC vapes, or cigarettes should not have to dig through flower lanes first. Check the category, check the current listing, then move. Simple beats heroic scrolling."
    },
  }
];
