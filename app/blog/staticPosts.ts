...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a Native Medicine Garden Visit Without Guessing",
    "seoTitle": "Native Medicine Garden Visit Guide | Weed Dispensary in Toronto",
    "seo_title": "Native Medicine Garden Visit Guide | Weed Dispensary in Toronto",
    "metaDescription": "Plan a Toronto visit to Native Medicine Garden with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Toronto visit to Native Medicine Garden with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a Native Medicine Garden Visit Without Guessing",
    "excerpt": "A practical visit guide for Native Medicine Garden, written for shoppers who want the next step without the runaround.",
  ...
  },
  {
    ...
    "title": "How to Compare Native Medicine Garden Flower Without Guessing",
    "seoTitle": "Native Medicine Garden Flower Guide | Budget to Exotic",
    "seo_title": "Native Medicine Garden Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Native Medicine Garden flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Native Medicine Garden flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Native Medicine Garden Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Native Medicine Garden.",
    "authorName": "Maya Cedar",
    "authorHandle": "@MayaMedicine",
    "authorRole": "House Writer",
    "author": "Maya Cedar",
  ...
  },
  {
    ...
    "title": "How to Shop the Native Medicine Garden Menu Like a Pro",
    "seoTitle": "Native Medicine Garden Menu Guide | Toronto Weed Store",
    "seo_title": "Native Medicine Garden Menu Guide | Toronto Weed Store",
    "metaDescription": "Shop the Native Medicine Garden menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Native Medicine Garden menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Native Medicine Garden Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Native Medicine Garden menu without turning the visit into a guessing game.",
    "authorName": "Noah Medicine",
    "authorHandle": "@NoahNative",
    "authorRole": "House Writer",
    "author": "Noah Medicine",
