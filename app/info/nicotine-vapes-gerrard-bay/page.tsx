  ...
  return (
    <>
      ...
      <SmokePilotLanding
        ...
        title="Nicotine Vapes Near Gerrard and Bay"
        ...
        sections={[
          ...
          { heading: "Pods and Disposables Downtown", body: "Compare listed Geek, OVNS, NEXA, STLTH, Uwell and Level X options by format, flavour, puff count and price." },
