...
export default function NicotineVapesPage() {
  return <><Navbar /><SmokePilotLanding
    ...
    intro="Searching for nicotine vapes near downtown Toronto or Bay Street? Browse these categories to explore current store information and product options before you visit or order. Product details can change. Nicotine is addictive."
    items={[]} menuHref="/items/vapes" menuLabel="Browse Nicotine Vapes"
    menuHeading="Six Live-Checked Native Medicine Garden Vape Cards"
    menuIntro="This shortlist includes Beast Mode, Geek, Level X, NEXA and OVNS vape product pages. Browse the relevant menu category for current product information."
    heroItems={[
    ...
    heroDisclosure="Browse these categories to explore current store information and product options before you visit or order."
    ...
    faqs={[
      { q: "Where should I check the current nicotine selection?", a: "Browse the relevant menu category for current product information." },
