...
export const TIER_SEO: Record<string, TierSeoData> = {
    ...
    faqs: [
      {
        ...
        a: "Exotic is one of the flower tiers shown on the Native Medicine Garden menu. It helps shoppers compare category, value, and potency context before visiting.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Premium is one of the flower tiers shown on the Native Medicine Garden menu. It helps shoppers compare category, value, and potency context before visiting.",
      },
      {
  ...
  "AAA+": {
    ...
    seoIntro:
      "Browse high-potency value category browsing at Native Medicine Garden near Gerrard Street West and Bay Street. Confirm current strains, prices, and availability before visiting.",
    sections: [
      {
    ...
    faqs: [
      {
        ...
        a: "AAA+ is one of the flower tiers shown on the Native Medicine Garden menu. It helps shoppers compare category, value, and potency context before visiting.",
      },
      {
  ...
  AA: {
    ...
    faqs: [
      {
        q: "What is AA flower?",
        a: "AA is one of the flower tiers shown on the Native Medicine Garden menu. It helps shoppers compare category, value, and potency context before visiting.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Budget is one of the flower tiers shown on the Native Medicine Garden menu. It helps shoppers compare category, value, and potency context before visiting.",
      },
      {
