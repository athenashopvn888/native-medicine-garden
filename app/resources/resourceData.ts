...
const SUPPORTING_PAGES: ResourcePage[] = [
  {
    ...
    description: "Use this practical guide to choose a Native Medicine Garden menu category first, then use the current product pages for changing details.",
    eyebrow: "Menu Guide",
    ...
    cards: [
      { title: "Weed & Flower Quality Guide", href: "/resources/weed-flower-guide", text: "Learn what the five Weed categories can and cannot tell you." },
    ...
    sections: [
      { heading: "Flower", body: "Flower is easiest to browse through the five Weed categories. Open the current category for changing product details." },
      ...
      { heading: "Edibles, THC Vapes and Concentrates", body: "Keep these as separate product types and use current product pages for changing details." },
...
export const RESOURCE_HOME: ResourcePage = {
  ...
  sections: [
    { heading: "Current Menu vs Resource Guides", body: "Use these resource pages for stable explanations and visit planning. Use the current Native Medicine Garden category and product pages for changing product names, prices, package formats and availability." },
